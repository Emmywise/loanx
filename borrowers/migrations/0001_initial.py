    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('working_status', models.CharField(blank=True, choices=[('Employer', 'Employer'), ('Government Employee', 'Government Employee'), ('Private Sector', 'Private Sector'), ('Employee', 'Employee'), ('Owner', 'Owner'), ('Student', 'Student'), ('Overseas Worker', 'Overseas Worker'), ('Pensioner', 'Pensioner'), ('Unemployed', 'Unemployed')], max_length=100)),
                ('borrower_photo', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True, verbose_name='image')),
                ('description', models.CharField(max_length=400)),
                ('authorization_code', models.CharField(blank=True, max_length=125, null=True)),
