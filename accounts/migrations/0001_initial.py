    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remaining_capital', models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=100)),
                ('spent_capital', models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=100)),
            ],
        ),
        migrations.CreateModel(
            name='Country',
