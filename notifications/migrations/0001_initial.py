    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_time', models.DateTimeField(auto_now_add=True)),
                ('status', models.CharField(blank=True, choices=[('sent', 'sent'), ('pending', 'pending'), ('failed', 'failed')], max_length=100)),
                ('message_purpose', models.CharField(blank=True, choices=[('to_all_borrowers', 'to_all_borrowers')], max_length=100)),
            ],
        ),
    ]
